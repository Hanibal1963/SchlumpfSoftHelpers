...
<Guid(SchlumpfSoft_HelpersPackage.PackageGuidString)>
Public NotInheritable Class SchlumpfSoft_HelpersPackage
	Inherits AsyncPackage

	''' <summary>
	''' Package guid
	''' </summary>
	Public Const PackageGuidString As String = "0f8effc8-2d5a-4a93-b311-1358bf4cacc1"
